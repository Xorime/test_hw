class ChartModel {
  ...
  ChartModel({required this.status, required this.name, required this.message, required this.errorCode, required this.code, required this.data, required this.pagination});
...
class Song {
  ...
  Song.fromJson(Map<String, dynamic> json) {
    title = json['title'];
    originalartist = (json['originalartist'] != null ? Originalartist.fromJson(json['originalartist']) : null)!;
    url = json['url'];
    image = json['image'];
...
class Pagination {
  ...
  Map<String, dynamic> toJson() {
    ...
    data['content_per_page'] = contentPerPage;
